...
SPECIALTY_MAPPING = {
    # Exact matches - these map directly 1:1
    'Cardiologia': ['Cardiologia'],
    'Neurologia': ['Neurologia'],
    'Ortopedia': ['Ortopedia', 'Ortopedia e Traumatologia'],
    'Oncologia': ['Oncologia'],
    'Pediatria': ['Pediatria', 'Neonatologia'],
    'Ginecologia': ['Ginecologia', 'Ginecologia e Ostetricia'],
    ...
    'Gastroenterologia': ['Gastroenterologia', 'Epatologia'],
    'Endocrinologia': ['Endocrinologia'],
    'Reumatologia': ['Reumatologia'],
    'Ematologia': ['Ematologia'],
    
    # Major categories that combine multiple specialties
    'Chirurgia': ['Chirurgia', 'Chirurgia Generale', 'Ortopedia e Traumatologia'],
    'Medicina Interna': ['Medicina Generale', 'Medicina Interna'],
    'Diagnostica': ['Diagnostica per Immagini', 'Radiologia', 'Medicina nucleare'],
    'Medicina d\'Urgenza': ['Pronto Soccorso', 'Urgenza'],
    'Riabilitazione': ['Riabilitazione', 'Fisioterapia', 'Medicina dello sport', 'Medicina sportiva'],
    'Medicina di Laboratorio': ['Analisi Cliniche'],
    'Trapianti': ['Trapianti', 'Trapiantologia'],
    'Malattie Infettive': ['Malattie infettive', 'Virologia', 'Medicina tropicale'],
    'Fertilità': ['Fertilità', 'Ginecologia', 'Ginecologia e Ostetricia'],
}
